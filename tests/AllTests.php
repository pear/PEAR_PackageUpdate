...
require_once 'PEAR_PackageUpdate_TestCase_DefaultConfig.php';
 ...
 * #phpunit --report tests/coverage PEAR_PackageUpdate_AllTests tests/AllTests.php
 *
...
class PEAR_PackageUpdate_AllTests
{
    ...
    public static function suite()
    {
        ...
        $suite->addTestSuite('PEAR_PackageUpdate_TestCase_DefaultConfig');
        return $suite;
    }
}
